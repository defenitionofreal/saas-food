...
from apps.authentication.api.logout import LogoutAPIView
...
urlpatterns = [
    ...
    # при jwt токенах логаут нету, планируется удалять токены на фронт-енде
    # или дописать logout и заносить токены в blacklist
