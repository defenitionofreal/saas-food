...
class TestCart(TestSetupBase):
    ...
    @classmethod
    def create_cart(cls):
        cls.cart = Cart.objects.create(institution=cls.institution, min_amount=cls.get_cart_min_amount())
    ...
    def test_customer_bonus_contribution_to_sale(self):
        ...
        customer_bonus = 30
        bonus = self.create_bonus(is_promo_code=True)
        db_cart.bonus = bonus
